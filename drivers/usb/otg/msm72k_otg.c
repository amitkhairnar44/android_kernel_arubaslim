...
#if defined(CONFIG_MACH_DELOS_DUOS_CTC) || defined(CONFIG_MACH_ARUBA_OPEN_CHN) || defined(CONFIG_MACH_DELOS_OPEN) || defined(CONFIG_MACH_ARUBA_CTC) || defined(CONFIG_MACH_KYLEPLUS_OPEN) || defined(CONFIG_MACH_ARUBASLIM_OPEN)|| defined(CONFIG_MACH_ROY)||defined(CONFIG_MACH_KYLEPLUS_CTC)
