...
#include "sr300pc20_regs_infinite.h"
#else
...
{
	return sr300pc20_control.dtpTest;
}
...
static void sr300pc20_set_scene_mode(int mode)
{
	...
	if(sr300pc20_control.settings.scenemode==mode){
		CAM_DEBUG("scene mode is same as previous");
		return;
	}
	...
	const struct i2c_device_id *id)
{
	...
	/*Qualcomm Guide - MIPI solution don't need check sensor at boot time.
