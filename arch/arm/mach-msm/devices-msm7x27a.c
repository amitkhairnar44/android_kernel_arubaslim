...
void __init msm8x25_kgsl_3d0_init(void)
{
		...
		kgsl_3d0_pdata.strtstp_sleepwake = false;
			...
			kgsl_3d0_pdata.pwrlevel[3].gpu_freq = 900000000;
			kgsl_3d0_pdata.pwrlevel[3].gpu_freq = 800000000;

			kgsl_3d0_pdata.pwrlevel[2].gpu_freq = 800000000;
			kgsl_3d0_pdata.pwrlevel[2].gpu_freq = 700000000;

			kgsl_3d0_pdata.pwrlevel[1].gpu_freq = 700000000;
			kgsl_3d0_pdata.pwrlevel[1].gpu_freq = 600000000;
